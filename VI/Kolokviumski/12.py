...
class Soccer(Problem):
    ...
    def are_positions_legal(self, attacker, ball):
    ...
    def move_attacker(self, state, where):
        ...
        if not self.are_positions_legal(attacker, ball):
            return None
...
if __name__ == '__main__':
    ...
    search = breadth_first_graph_search(soccer_problem)
    # print(search)
    if search:
